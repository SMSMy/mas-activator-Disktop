...
قد تعترض حماية النظام (Windows Security / مضادات الفيروسات) أدوات التفعيل مفتوحة المصدر، وقد تُحذف ملفاتها تلقائيًا نتيجة **بلاغات كاذبة** شائعة في هذا المجال. إن حدث ذلك:

- تحقق من سلامة الملف عبر قيمة SHA-256 المنشورة في صفحة الإصدارات
- قدّم بلاغ «إيجابية خاطئة» لمايكروسوفت عبر [wdsi/filesubmission](https://www.microsoft.com/en-us/wdsi/filesubmission) — هذا يساعد المجتمع كله
- إن وثقت بالمصدر يمكنك استثناء الملف من الفحص في إعدادات حماية Windows

**أي تغيير في إعدادات الحماية قرارك ومسؤوليتك.**
